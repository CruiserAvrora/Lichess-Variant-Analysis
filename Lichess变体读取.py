...
save_name = "C:/Users/ad674/Downloads/horde.xlsx"
...
while count <= 105:
    ...
    for i in range(1,max_elo):
        ...
        for j in range (1,7):
            sheet1.write(i,j+6*count,result_total[i][j-1])
    for i in range(1,max_elo):
        if count == 0:
            sheet2.write(i,0,i)
        ...
        for j in range (1,7):
            sheet2.write(i,j+6*count,result_ub[i][j-1])
    for i in range(1,max_elo):
        if count == 0:
            sheet3.write(i,0,i)
        ...
        for j in range (1,7):
            sheet3.write(i,j+6*count,result_bu[i][j-1])
    for i in range(1,max_elo):
        if count == 0:
            sheet4.write(i,0,i)
        ...
        for j in range (1,7):
            sheet4.write(i,j+6*count,result_bl[i][j-1])
    for i in range(1,max_elo):
        if count == 0:
            sheet5.write(i,0,i)
        ...
        for j in range (1,7):
            sheet5.write(i,j+6*count,result_rp[i][j-1])
    for i in range(1,max_elo):
        if count == 0:
            sheet6.write(i,0,i)
        ...
        for j in range (1,7):
            sheet6.write(i,j+6*count,result_cl[i][j-1])
    count += 1
